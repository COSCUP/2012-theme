  ...
  <div class="info">
    ...
    <div id="connect_box">
      <ul>
        ...
        <li><a title="<?php echo $lc->_("Flickr");?>" href="http://www.flickr.com/photos/coscup/" target="_blank"><span class="sprite flickr"></span></a></li>
        <li><a title="<?php echo $lc->_("YouTube");?>" href="http://www.youtube.com/user/thecoscup" target="_blank"><span class="sprite youtube"></span></a></li>
